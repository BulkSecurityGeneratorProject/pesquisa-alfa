(function() {
    ...
    angular
        ...
        .controller('UC10DialogController', UC10DialogController);

    UC10DialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', '$q', 'entity', 'Proposta', 'Aluno', 'Orientador'];

    function UC10DialogController ($timeout, $scope, $stateParams, $uibModalInstance, $q, entity, Proposta, Aluno, Orientador) {
        var vm = this;
