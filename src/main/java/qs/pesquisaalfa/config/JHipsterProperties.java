...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pesquisaalfa@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pesquisaalfa API";

        private String description = "pesquisaalfa API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pesquisaalfa";
